...
Apache-2.0 不代表你可以访问 `visual-grammar-foundry-core`、私有运行产物、未公开的方法或第三方内容。子项目有自己的许可证和权利记录；子项目许可证只覆盖其创建者有权许可的原创内容。源素材、字体、商标、logo、用户提供的文字和其他第三方内容仍受各自条款约束。使用 Apache-2.0 覆盖的仓库代码进行商业活动通常不需要额外付费或授权，但仍必须审查所有第三方权利和具体子项目许可证。
